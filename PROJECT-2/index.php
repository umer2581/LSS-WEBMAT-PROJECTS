            ...
            <div class="contentarea">
                    ...
                    <div class="cncont">
                        <marquee direction="up" scrolldelay="25">
                            <ul class="latest-news-ul"> 
                                <li><nheading>AIRWAYS APP</nheading><br>
                                        We wish to inform you that we have launched android mobile app tool. The tool has got the features like Pincode Finder, Consignment tracking, Branch finder, Price & Weight calculator facility. App has also got the feature of online POD & DRS updation with capture of receiver sign on the handheld device's on real time. AIRWAYS App is available at Play Store for the users<img src="images/newso.gif" ></li>
                                <li><nheading>6-May-2023
                                    OTP FRAUD AWARENESS PUBLIC NOTICE</nheading><br>
                                    Staying alert and aware is the simplest way to avoid OTP Fraud Airway courier India pvt ltd do not ask to share OTP/UPI pin. Any such request on phone will be treated has fraud call<img src="images/newso.gif" ></li>
                                <li><nheading>NEW OFFICE OPEN IN BARODA AND MORADABAD AND BLR SR NAGAR (HUB OFFICE)</nheading><br>
                                    We are very pleased and proud to Announce that We have expanded our own one More HUB Office at Baroda and moradabad and BLR SR NAGAR (HUB OFFICE) Now our fine Service line is conveniently available to our downtown customers.
                                    <img src="images/newso.gif" ></li>
                ...
                <div class="row">
                    <div class="rleft">
                        ...
                        concern for the customer takes us beyond the traditional ways of handling our business.At Airways Courier, we does not limit our duties to the mere, "you pay me, I work" policy. Our
