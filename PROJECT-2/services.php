...
<body>
    ...
    <div class="outer">
        ...
        <div class="scontainer"
            style="background-image: url(images/sback2.jpg); height: 100%; width: 100%; background-size:cover;">
            <div class="sleft">
                ...
                <br>
                <p>
                    Diplomatic Service: When deliveries for certain far off places are undertaken, to avoid a possible
                    delay, the franchisee of the particular area will undertake the responsibility of delivering the
                    goods. This way, we lessen the chances of a possible delay in delivery
                </p>
                <br>
                <p>
                    Customer Support and Customer Services: Since we are in a service industry, lot of care has to be
                    given to this area. Our policy towards the customer care is "what problems do customers have and
                    what resources do we have to solve them?" At Airways
                </p>
                ...
                <div class="fcontact">
                    ...
                    <div class="fleft">
                        ...
                        <p> AIRWAYS COURIER is one of the largest Indian company in the Express industry. AIRWAYS
                            ...
                            India, and today has the largest franchisee network</p>
