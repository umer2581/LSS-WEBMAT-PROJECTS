<div class="cleft">
  ...
  <div class="dropdown">
      ...
      <div class="dropdown-content">
<button class="dropdown-item" onclick="location.href='ViewGallery.php'">Home Slider1</button>
          <button class="dropdown-item" onclick="location.href='ViewGallery2.php'">View Gallery2</button>
          <button class="dropdown-item" onclick="location.href='ViewGallery3.php'">View Gallery3</button>
      </div>
  </div>
