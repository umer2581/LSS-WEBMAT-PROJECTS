...
if (isset($_POST['gimage'])) {
  ...
  if ($image['size'] > 0) {
    ...
    if (move_uploaded_file($image["tmp_name"], $targetFile)) {
      ...
      $insertQuery = "INSERT INTO homeslider1 (filename) VALUES ('$targetFile')";
...
if (isset($_POST['simage'])) {
    ...
    if ($image['size'] > 0) {
      ...
      if (move_uploaded_file($image["tmp_name"], $targetFile)) {
        // Insert the image details into the database
        $insertQuery = "INSERT INTO homeslider2 (filename) VALUES ('$targetFile')";
        if (mysqli_query($conn, $insertQuery)) {
          // Image uploaded and inserted successfully
          header("Location: ".$_SERVER['PHP_SELF']); // Reload the page
          exit;
...
<body>
    <div class="outer">
        ...
        <div class="container">
            <!-- cleft if here -->
            <?php include("cleftchange.php"); ?>
            <div class="cright">
                <h3>Add Images to Home Slider 1 :-</h3>
                <div class="aboutf">
                ...
                <h3>Add Images to Home Slider 2 :-</h3>
                <div class="aboutf">
                <form method="post" enctype="multipart/form-data">
                    <div class="nrow">
                        <input type="file" name="image" required>
                    ...
                    <div>
                        <input type="submit" name="simage" value="Add Image" class="contact-sub">
                    </div>
                </form>
                </div>
                <hr>
