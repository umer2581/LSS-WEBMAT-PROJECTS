...
<div class="cleft">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <button class="dropdown-item" onclick="location.href='addimagegallery.php'">Image Gallery</button>
            <button class="dropdown-item" onclick="location.href='addimagetoslider.php'">Slider Gallery</button>
     ...
     <div class="dropdown">
        ...
        <div class="dropdown-content">
            <button class="dropdown-item" onclick="location.href='viewimagegallery.php'">Image Gallery</button>
            <button class="dropdown-item" onclick="location.href='viewslidergallery.php'">Slider Gallery</button>
    ...
    <button class="button" onclick="location.href='change-pass.php'">Change Password</button>
</div>
<style>
.cleft {
  width: 30%;
