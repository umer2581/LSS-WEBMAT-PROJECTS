...
if (isset($_POST['single_delete'])) {
    ...
    $filePath = "../simages/" . $filename;
    if (file_exists($filePath)) {
        unlink($filePath);
    }

    $deleteQuery = "DELETE FROM simages WHERE filename = '$filename'";
    mysqli_query($conn, $deleteQuery);
    header("Location: sliderg.php");
    exit();
}


$selectQuery = "SELECT * FROM simages";
                ...
                <div class="image-table">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class="image-table-row">
                            ...
                            <div class="image"><img src="../simages/<?php echo $filename; ?>" alt="Preview" class="image-preview"></div>
                            <div class="action">
